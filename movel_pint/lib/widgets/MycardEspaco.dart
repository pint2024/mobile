...
import 'package:movel_pint/espaço/detalhesEspaco.dart'; // Importa a página detalhesEvento.dart

class MyCardEspaco extends StatelessWidget {
  @override
    ...
    return GestureDetector( // Adiciona um GestureDetector para detectar cliques
      onTap: () {
        Navigator.push( // Navega para a página detalhesEvento.dart quando clicado
          context,
          MaterialPageRoute(builder: (context) => SpaceDetailsPage()), // Substitua DetalhesEvento() pela classe correta se necessário
        );
      },
      child: Card(
        elevation: 3,
