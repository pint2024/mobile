...
import 'package:movel_pint/recomedacao/detalhesRecomendacao.dart'; // Importa a página detalhesEvento.dart

class MyCardRecomendacao extends StatelessWidget {
  @override
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: Text('Título da recomedação'),
